...
time_min = datetime.datetime.strptime("1900-04-26 18:00:00.000", "%Y-%m-%d %H:%M:%S.%f")
time_max = datetime.datetime.strptime("2022-04-27 08:00:00.000", "%Y-%m-%d %H:%M:%S.%f")
label = 'crrt_segment'
