...
list_IMUs_for_plot = ['10', '2', '3', '4',  '6', '7', '8', '9']
...
for crrt_IMU in list_IMUs_for_plot:
    ...
    #f, crrt_Pxx = signal.welch(crrt_elev, FS, nperseg=nperseg, noverlap=overlap)
    ooo = int(nperseg*0.50)
    f, crrt_Pxx = signal.csd(crrt_elev, crrt_elev, fs=FS, nperseg=nperseg, noverlap=ooo, return_onesided=True)
...
f, damping = compute_damping("6", "3", distance_m=distance_1, index_limits=(ind_min, ind_max), smoothing=False, plot=False)
f_min = 0.065
f_max = 0.09
ind_min = find_min_gt_index_in_ordered_array(f, f_min)
ind_max = find_min_gt_index_in_ordered_array(f, f_max)
...
# plot the dampings
f, damping = compute_damping("6", "3", distance_m=distance_1, index_limits=(ind_min, ind_max))
...
f, damping = compute_damping("6", "4", distance_m=distance_1, index_limits=(ind_min, ind_max))
list_all_damping.append(damping)
frequency_for_fit = np.append(frequency_for_fit, f)
damping_for_fit = np.append(damping_for_fit, damping)
f, damping = compute_damping("6", "2", distance_m=distance_2, index_limits=(ind_min, ind_max))
list_all_damping.append(damping)
frequency_for_fit = np.append(frequency_for_fit, f)
damping_for_fit = np.append(damping_for_fit, damping)
f, damping = compute_damping("3", "6", distance_m=distance_2, index_limits=(ind_min, ind_max))
list_all_damping.append(damping)
frequency_for_fit = np.append(frequency_for_fit, f)
damping_for_fit = np.append(damping_for_fit, damping)
...
frequency_for_fit = np.append(frequency_for_fit, f)
damping_for_fit = np.append(damping_for_fit, damping)
f, damping = compute_damping("8", "6", distance_m=distance_1, index_limits=(ind_min, ind_max))
list_all_damping.append(damping)
frequency_for_fit = np.append(frequency_for_fit, f)
damping_for_fit = np.append(damping_for_fit, damping)
...
f, damping = compute_damping("6", "3", distance_m=distance_1, smoothing=False, plot=False)
f_min = 0.065
f_max = 0.16
ind_min = find_min_gt_index_in_ordered_array(f, f_min)
ind_max = find_min_gt_index_in_ordered_array(f, f_max)
...
# plot the dampings
f, damping = compute_damping("6", "3", distance_m=distance_1, index_limits=(ind_min, ind_max), smoothing=False)
list_all_damping.append(damping)
frequency_for_fit = np.append(frequency_for_fit, f)
damping_for_fit = np.append(damping_for_fit, damping)
f, damping = compute_damping("6", "4", distance_m=distance_1, index_limits=(ind_min, ind_max), smoothing=False)
list_all_damping.append(damping)
frequency_for_fit = np.append(frequency_for_fit, f)
damping_for_fit = np.append(damping_for_fit, damping)
...
f, damping = compute_damping("6", "3", distance_m=distance_1, smoothing=smooting, plot=False)
f_min = 0.065
f_max = 0.079
f_min_total = f_min
f_min_interm = f_max
...
f, damping = compute_damping("6", "3", distance_m=distance_1, index_limits=(ind_min, ind_max), smoothing=smooting)
list_all_damping.append(damping)
frequency_for_fit = np.append(frequency_for_fit, f)
damping_for_fit = np.append(damping_for_fit, damping)
f, damping = compute_damping("6", "4", distance_m=distance_1, index_limits=(ind_min, ind_max), smoothing=smooting)
list_all_damping.append(damping)
frequency_for_fit = np.append(frequency_for_fit, f)
damping_for_fit = np.append(damping_for_fit, damping)
...
# plot the dampings
_ = compute_damping("6", "3", distance_m=distance_1, index_limits=(ind_min, ind_max), smoothing=False)
list_all_damping.append(damping)
frequency_for_fit = np.append(frequency_for_fit, f)
damping_for_fit = np.append(damping_for_fit, damping)
_ = compute_damping("6", "4", distance_m=distance_1, index_limits=(ind_min, ind_max), smoothing=False)
list_all_damping.append(damping)
frequency_for_fit = np.append(frequency_for_fit, f)
damping_for_fit = np.append(damping_for_fit, damping)
